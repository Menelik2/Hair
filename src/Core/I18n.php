...
/**
 * Full bilingual (English / Amharic) i18n.
 */
final class I18n
{
    ...
    private static function loadMessages(): void
    {
        ...
        self::$messages = [
            'en' => [
                ...
                'nav.back' => 'Back', 'nav.login' => 'Sign In', 'nav.logout' => 'Sign Out',
                'nav.kiosk' => 'Customer Kiosk',
                ...
                'common.date' => 'Date', 'common.time' => 'Time', 'common.service' => 'Service',
                ...
                'queue.fastest' => 'Fastest option', 'queue.your_name' => 'Your Name',
                'queue.your_phone' => 'Your Phone Number', 'queue.join' => 'Get My Ticket',
                'queue.total' => 'Total', 'queue.duration' => 'Duration',
                'queue.paused' => 'Walk-in queue is temporarily paused. Please try again later.',
                'queue.next' => 'Next', 'queue.step_services' => 'Services', 'queue.step_barber' => 'Barber',
                'queue.step_details' => 'Details',
                ...
                'ticket.customer' => 'Customer', 'ticket.phone' => 'Phone', 'ticket.services' => 'Services',
                'ticket.code' => 'Ticket',
                ...
                'login.title' => 'Staff & Admin Login', 'login.submit' => 'Sign In',
                'login.invalid' => 'Invalid phone or password',
                ...
                'station.break' => 'Break', 'station.offline' => 'Off Duty',
                'station.no_waiting' => 'No customers waiting', 'station.timer' => 'Elapsed',
                'board.now_serving' => 'Now Serving', 'board.up_next' => 'Up Next', 'board.live' => 'Live',
                'board.chair' => 'Chair',
                'admin.dashboard' => 'Admin', 'admin.revenue' => 'Daily Revenue',
                'admin.served' => 'Customers Served', 'admin.queue' => 'Active Queue',
                'admin.avg_wait' => 'Avg Wait Time', 'admin.pause' => 'Pause Walk-In Queue',
                'admin.resume' => 'Resume Walk-In Queue',
            ],
            'am' => [
                'app.name' => 'ኤሊት ካትስ', 'app.tagline' => 'ፕሪሚየም የፀጉር ቤት',
                'nav.queue' => 'ወረፋ', 'nav.book' => 'ቀጠሮ', 'nav.profile' => 'መገለጫ',
                'nav.back' => 'ተመለስ', 'nav.login' => 'ግባ', 'nav.logout' => 'ውጣ',
                'nav.kiosk' => 'የደንበኛ ኪዮስክ',
                'common.continue' => 'ቀጥል', 'common.cancel' => 'ሰርዝ', 'common.confirm' => 'አረጋግጥ',
                'common.save' => 'አስቀምጥ', 'common.loading' => 'በመጫን ላይ…', 'common.error' => 'ስህተት ተከስቷል',
                'common.min' => 'ደቂቃ', 'common.etb' => 'ብር', 'common.any_barber' => 'ማንኛውም ባርበር',
                'common.name' => 'ሙሉ ስም', 'common.phone' => 'ስልክ', 'common.password' => 'የይለፍ ቃል',
                'common.date' => 'ቀን', 'common.time' => 'ሰዓት', 'common.service' => 'አገልግሎት',
                'queue.title' => 'ወረፋ ውስጥ ይግቡ', 'queue.select_service' => 'አገልግሎቶችን ይምረጡ',
                'queue.select_stylist' => 'ባርበርዎን ይምረጡ', 'queue.first_available' => 'መጀመሪያ የሚገኝ',
                'queue.fastest' => 'ፈጣኑ አማራጭ', 'queue.your_name' => 'ስምዎ',
                'queue.your_phone' => 'ስልክ ቁጥርዎ', 'queue.join' => 'ቲኬቴን አግኝ',
                'queue.total' => 'ጠቅላላ', 'queue.duration' => 'ጊዜ',
                'queue.paused' => 'ወረፋው ለጊዜው ቆሟል። እባክዎ ቆይተው ይሞክሩ።',
                'queue.next' => 'ቀጣይ', 'queue.step_services' => 'አገልግሎቶች', 'queue.step_barber' => 'ባርበር',
                'queue.step_details' => 'ዝርዝር',
                'ticket.title' => 'ቲኬትዎ', 'ticket.you_are' => 'እርስዎ', 'ticket.in_line' => 'ኛ በመስመር ላይ ነዎት',
                'ticket.estimated_wait' => 'የሚጠበቅ ጊዜ', 'ticket.cancel' => 'ቲኬቴን ሰርዝ',
                'ticket.cancel_confirm' => 'ቲኬትዎን ይሰርዙ?', 'ticket.cancel_yes' => 'አዎ፣ ሰርዝ',
                'ticket.called' => 'ተራዎ ነው!', 'ticket.called_go' => 'እባክዎ ወደ ወንበር ይሂዱ',
                'ticket.in_chair_msg' => 'በወንበር ላይ ነዎት', 'ticket.enjoy' => 'ጥሩ ፀጉር አስተካክል ይሁንልዎ',
                'ticket.completed' => 'አገልግሎቱ ተጠናቋል። እናመሰግናለን!', 'ticket.cancelled' => 'ቲኬቱ ተሰርዟል',
                'ticket.customer' => 'ደንበኛ', 'ticket.phone' => 'ስልክ', 'ticket.services' => 'አገልግሎቶች',
                'ticket.code' => 'ቲኬት',
                'status.waiting' => 'በመጠበቅ ላይ', 'status.called' => 'ተጠርቷል', 'status.in_chair' => 'በወንበር ላይ',
                'status.completed' => 'ተጠናቋል', 'status.cancelled' => 'ተሰርዟል',
                'appt.title' => 'ቀጠሮ ይያዙ', 'appt.subtitle' => 'የሚፈልጉትን ሰዓትና ባርበር ይምረጡ',
                'appt.confirm' => 'ቀጠሮውን አረጋግጥ', 'appt.success' => 'ቀጠሮ ተይዟል!',
                'appt.success_msg' => 'በዚያን ጊዜ እንገናኛለን።', 'appt.walkin' => 'በቀጥታ መምጣት ይፈልጋሉ?',
                'appt.join_queue' => 'ወደ ወረፋ ይግቡ', 'appt.preferred_barber' => 'የሚመርጡት ባርበር',
                'appt.select_service' => 'አገልግሎት ይምረጡ', 'appt.any' => 'ማንኛውም የሚገኝ',
                'profile.title' => 'መገለጫዬ', 'profile.sign_in' => 'ግባ', 'profile.register' => 'ተመዝገብ',
                'profile.create' => 'መለያ ፍጠር', 'profile.cuts' => 'ፀጉር አስተካክሎች', 'profile.spent' => 'የወጣ ብር',
                'profile.favorite' => 'ተወዳጅ', 'profile.history' => 'የቅርብ ጊዜ ጉብኝቶች',
                'profile.no_history' => 'እስካሁን የተጠናቀቀ ጉብኝት የለም።', 'profile.logout' => 'ውጣ',
                'login.title' => 'የሰራተኛና አስተዳዳሪ መግቢያ', 'login.submit' => 'ግባ',
                'login.invalid' => 'ስልክ ወይም የይለፍ ቃል ትክክል አይደለም',
                'station.call_next' => 'ቀጣዩን ጥራ', 'station.finish' => 'ጨርስ እና ክፈል', 'station.start' => 'ጀምር',
                'station.walk_in' => 'ቀጥታ መጪ', 'station.up_next' => 'ቀጣይ', 'station.active' => 'ንቁ',
                'station.break' => 'እረፍት', 'station.offline' => 'ከስራ ውጭ',
                'station.no_waiting' => 'በመጠበቅ ላይ ያለ ደንበኛ የለም', 'station.timer' => 'ያለፈ ጊዜ',
                'board.now_serving' => 'አሁን በአገልግሎት', 'board.up_next' => 'ቀጣይ በመስመር', 'board.live' => 'ቀጥታ',
                'board.chair' => 'ወንበር',
                'admin.dashboard' => 'አስተዳዳሪ', 'admin.revenue' => 'የዕለት ገቢ',
                'admin.served' => 'ያገለገሉ ደንበኞች', 'admin.queue' => 'ንቁ ወረፋ',
                'admin.avg_wait' => 'አማካይ የመጠበቅ ጊዜ', 'admin.pause' => 'ወረፋውን አቁም',
                'admin.resume' => 'ወረፋውን ቀጥል',
            ],
        ];
    }
}
